...
public abstract class Hilt_DownloadAlarmReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((DownloadAlarmReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectDownloadAlarmReceiver(UnsafeCasts.<DownloadAlarmReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
