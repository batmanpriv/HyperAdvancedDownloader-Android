...
public abstract class Hilt_TriggerReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((TriggerReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectTriggerReceiver(UnsafeCasts.<TriggerReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
