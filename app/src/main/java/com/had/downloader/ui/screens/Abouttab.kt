...
private const val CURRENT_VERSION = "3.7.13"
                ...
                UpdateSection(
                    ...
                    onDownloadUpdate = {
                        scope.launch {
                            ...
                            val success = downloadAndInstallApk(context, apkUrl) { progress ->
                            ...
                            if (success) {
                                ...
                                updateStatus = UpdateStatus.Error("Download failed")
                            }
                        }
                    }
                )
        ...
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    Icon(
                        if (updateStatus is UpdateStatus.Available || updateStatus == UpdateStatus.Downloaded)
                            Icons.Filled.SystemUpdateAlt
                        else Icons.Outlined.Info,
                        null,
                        tint = when (updateStatus) {
                            is UpdateStatus.Available -> GreenSuccess
                            UpdateStatus.Downloaded -> GreenSuccess
            ...
            when (updateStatus) {
                ...
                UpdateStatus.Downloaded -> {
                    Row(
                        ...
                        Text(
                            L("دانلود کامل شد! نصب خودکار شروع می‌شود.", "Download complete! Installation will start automatically.").get(lang),
                            color = GreenSuccess,
                            fontSize = 12.sp,
                            fontWeight = FontWeight.Medium,
                            modifier = Modifier.weight(1f)
...
private suspend fun downloadAndInstallApk(
    ...
    try {
        ...
        val apkFile = File(cacheDir, "HAD_update.apk")
