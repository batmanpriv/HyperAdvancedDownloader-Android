...
fun GuideTab() {
    ...
    val lang = if (LanguageManager.isFa) GuideLang.FA else GuideLang.EN
        ...
        Box(modifier = Modifier.fillMaxSize().background(SpaceBlack)) {
            ...
            Column(
                ...
                Row(
                    ...
                    GuideLangSwitcher(lang = lang, onChange = {
                        LanguageManager.setLanguage(context, if (it == GuideLang.FA) AppLanguage.FA else AppLanguage.EN)
                    })
                }
