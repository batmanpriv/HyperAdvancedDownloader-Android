        ...
        title = {
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column {
                        Text(
                            t("Select Quality", "انتخاب کیفیت"),
                            color = TextPrimary,
                            fontWeight = FontWeight.Bold,
                            fontSize = 18.sp
                        )
                        Text(
                            if (loading && streams.isEmpty()) t("Looking for available qualities…", "درحال جستجوی کیفیت‌های موجود…")
            ...
            Column(
                ...
                if (loading && streams.isEmpty()) {
                    Column(
                        ...
                        Text(
                            t("Reading available qualities from the page…", "درحال خواندن کیفیت‌های موجود از صفحه…"),
                            color = TextSecondary,
                            fontSize = 13.sp
                        )
                        Text(
                            t("This can take a bit longer on a slow connection", "با اینترنت کند ممکنه کمی طول بکشه"),
                            color = TextMuted,
                            fontSize = 11.sp
                        )
                    }
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Text(
                            t("Choose a quality to download. Higher quality = larger file.", "یک کیفیت برای دانلود انتخاب کن. کیفیت بالاتر = حجم بیشتر."),
                            color = TextMuted,
                            fontSize = 11.sp,
                            lineHeight = 15.sp
                        )
                ...
                if (streams.isEmpty()) {
                    Box(
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text(
                                t("No quality options available", "گزینه‌ی کیفیتی موجود نیست"),
                                color = TextMuted,
                                fontSize = 13.sp
                            )
                        }
                    ...
                    AnimatedVisibility(
                        ...
                        Surface(
                            ...
                            Row(
                                ...
                                Text(
                                    t("Selected: ", "انتخاب‌شده: ") + "${stream.quality.label} · ${formatDuration(stream.durationSeconds)}",
                                    color = CyanPrimary,
                                    fontSize = 12.sp,
        ...
        confirmButton = {
            Row(
                ...
                TextButton(onClick = onDismiss) {
                    Text(t("Cancel", "انصراف"), color = TextSecondary)
                }
                ...
                OutlinedButton(
                    ...
                    if (isQueuing) {
                        ...
                        Text(t("Queuing...", "درحال افزودن به صف..."), fontWeight = FontWeight.Medium)
                    } else {
                        Icon(Icons.Outlined.AddCircleOutline, null, modifier = Modifier.size(16.dp))
                        Spacer(Modifier.width(6.dp))
                        Text(t("Queue", "صف"), fontWeight = FontWeight.Medium)
                    }
                }
                ...
                Button(
                    ...
                    if (isDownloading) {
                        ...
                        Spacer(Modifier.width(8.dp))
                        Text(t("Starting...", "درحال شروع..."), fontWeight = FontWeight.Bold)
                    } else {
                        Icon(Icons.Filled.Download, null, modifier = Modifier.size(16.dp))
                        Spacer(Modifier.width(6.dp))
                        Text(t("Download", "دانلود"), fontWeight = FontWeight.Bold)
                    }
                }
            }
        }
