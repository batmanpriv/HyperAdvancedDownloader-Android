...
import com.had.downloader.ui.components.QRCodeDialog
...
fun RemoteServerTab(vm: MainViewModel) {
    ...
    var showQRCodeForServer by remember { mutableStateOf(false) }
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    Text(
                        t("Remote Download Server", "سرور دانلود ریموت"),
                        color = TextPrimary,
                        fontSize = 17.sp,
                        fontWeight = FontWeight.Bold
                    )
                    Text(
                        t("Control HAD from your PC browser", "کنترل HAD از مرورگر کامپیوترت"),
                        color = TextMuted,
                        fontSize = 11.sp
                    )
                }
            ...
            AnimatedVisibility(visible = serverState.isRunning) {
                Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
                    LiveAddressCard(
                        ...
                        onShowQR = { showQRCodeForServer = true }
                    )
    ...
    if (showQRCodeForServer && serverState.isRunning) {
        QRCodeDialog(
            url = "http://${serverState.ipAddress}:${serverState.port}",
            filename = "HAD_Remote_Server",
            onDismiss = { showQRCodeForServer = false }
        )
    }
}
        ...
        Column(Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
            ...
            Row(
                ...
                Row(
                    ...
                    Column {
                        Text(
                            if (serverState.isRunning) t("Server Online", "سرور روشن") else t("Server Offline", "سرور خاموش"),
                        ...
                        Text(
                            if (serverState.isRunning)
                                t("Listening on port ", "درحال شنود روی پورت ") + "${serverState.port}"
                            else
                                t("Tap to start accepting downloads", "برای شروع پذیرش دانلودها لمس کن"),
                            color = TextMuted,
                            fontSize = 11.sp
                        )
                    }
            ...
            Button(
                ...
                Text(
                    if (serverState.isRunning) t("Stop Server", "توقف سرور") else t("Start Server", "شروع سرور"),
                    fontSize = 16.sp,
...
private fun LiveAddressCard(
    ...
    Surface(
        ...
        Column(Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            Text(
                t("OPEN IN PC BROWSER", "باز کردن در مرورگر کامپیوتر"),
            ...
            Row(
                ...
                IconButton(
                    ...
                    modifier = Modifier
                        .size(36.dp)
                        .background(GreenSuccess.copy(alpha = 0.1f), RoundedCornerShape(8.dp))
                ) {
                    Icon(
            ...
            Text(
                t("Make sure your PC and phone are on the same Wi-Fi network", "مطمئن شو کامپیوتر و گوشیت روی یک وای‌فای هستن"),
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Row(
            ...
            Row(
                ...
                Text(
                    t("INCOMING REQUESTS", "درخواست‌های ورودی"),
                    color = TextMuted,
                    fontSize = 9.sp,
                    fontFamily = FontFamily.Monospace,
                    letterSpacing = 2.sp,
        ...
        Column(Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            Row(
                ...
                Column(Modifier.weight(1f)) {
                    Text(
                        filename.ifBlank { t("Remote download", "دانلود ریموت") },
                        color = TextPrimary,
                        fontSize = 13.sp,
                        fontWeight = FontWeight.SemiBold,
                        maxLines = 1,
            ...
            Row(
                ...
                Button(
                    ...
                    Spacer(Modifier.width(5.dp))
                    Text(
                        if (isHls) t("Download HLS", "دانلود HLS") else t("Download Now", "دانلود همین حالا"),
                        fontSize = 12.sp,
                        fontWeight = FontWeight.Bold
                    )
                }
    ...
    Surface(
        ...
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            Row(
                ...
                Text(
                    t("How it works", "چطور کار می‌کند"),
                    color = CyanPrimary,
                    fontSize = 12.sp,
                    fontWeight = FontWeight.SemiBold
                )
            ...
            val steps = listOf(
                t("Start the server — your phone starts listening on port 8080", "سرور را روشن کن — گوشی روی پورت ۸۰۸۰ شروع به شنود می‌کند"),
                t("Connect your PC to the same Wi-Fi network as your phone", "کامپیوتر را به همان وای‌فای گوشی وصل کن"),
                t("Open the displayed IP:port URL in any PC browser", "آدرس IP:port نمایش داده‌شده را در مرورگر کامپیوتر باز کن"),
                t("Paste any download link in the web UI — it lands on your phone instantly", "هر لینک دانلودی را در صفحه‌ی وب بچسبان — فوراً روی گوشی می‌آید"),
                t("Choose Download Now to start immediately, or Queue to schedule", "«دانلود همین حالا» برای شروع فوری، یا «صف» برای زمان‌بندی")
            )
