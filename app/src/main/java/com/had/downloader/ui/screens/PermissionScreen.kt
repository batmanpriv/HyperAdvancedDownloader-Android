...
fun PermissionScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = t("Storage Permission Required", "دسترسی حافظه لازم است"),
                color = TextPrimary,
                fontSize = 24.sp,
            ...
            Text(
                text = t("Allow file access to save downloads on your device.", "برای ذخیره‌ی دانلودها روی گوشی، دسترسی فایل را اجازه بده."),
                color = TextSecondary,
                textAlign = TextAlign.Center
            )
            ...
            Button(
                ...
                Text(
                    text = t("Grant Permission", "دادن دسترسی")
                )
            }
            ...
            TextButton(
                ...
                Text(
                    text = t("Exit App", "خروج از برنامه"),
                    color = TextMuted
                )
            }
        }
